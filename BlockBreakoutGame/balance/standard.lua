-- ==========================================================================
-- BALL PIT X — DAMAGE MASTER FILE — Standard paddle
-- ==========================================================================
-- This file is the single source of truth for every damage number in the
-- game WHILE THE Standard PADDLE IS EQUIPPED. Each paddle has its own copy
...
return {
  ...
  loadout = {
    dmg = 1.0, size = 1.0, move = 1.0, ball = 1.0, charge = 1.0, aim = 1.0,
    xp = 1.0, combo = 1.0, hp = 5,
  },

  -- Standard has no signature power.
  signature = {},
  ...
  -- Standard: an honest mid-length baseline sight.
  aim = {
    path_base      = 110,
    path_per_level = 10,
  },
