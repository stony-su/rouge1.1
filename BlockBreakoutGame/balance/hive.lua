...
return {
  ...
  loadout = {
    dmg = 1.0, size = 1.0, move = 1.0, ball = 0.8, charge = 0.7, aim = 0.8,
    xp = 1.6, combo = 0.9, hp = 4,
  },

  -- Balls deal ZERO contact damage (contact_zero); every bounce spawns a
  -- maggot that seeds the infestation rot (see dots.infest_*).
  signature = {
    contact_zero    = true,
  ...
  -- Hive: swarm instinct over optics — short, grows slowly.
  aim = {
    path_base      = 80,
    path_per_level = 7,
  },
