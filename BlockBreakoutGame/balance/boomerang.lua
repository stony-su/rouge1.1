...
return {
  ...
  loadout = {
    dmg = 1.4, size = 1.0, move = 1.0, ball = 1.2, charge = 0.6, aim = 1.3,
    xp = 1.0, combo = 0.7, hp = 5,
  },

  -- Balls curl back to the paddle after wall hits (no direct damage knobs).
  signature = {
    turn_rate = 5,
  },
  ...
  -- Boomerang: trajectory mastery IS the fantasy — long.
  aim = {
    path_base      = 160,
    path_per_level = 14,
  },
