...
return {
  ...
  loadout = {
    dmg = 1.6, size = 1.0, move = 0.9, ball = 1.0, charge = 1.0, aim = 0.9,
    xp = 0.5, combo = 1.1, hp = 4,
  },

  -- Binary Fusion: bonded pairs orbit, FUSE, and detonate a nova supercast.
  signature = {
    cd_mult      = 0.75,   -- ability cooldown multiplier for all balls
    fuse_time    = 8,      -- seconds of play to fill the fusion charge
    fuse_window  = 0.42,   -- how long the twins stay fused
    split_cd     = 0.6,    -- beat after a split before charge resumes
    nova_radius  = 80,
    ...
    nova_burn_duration  = 2.5,
    nova_slow_factor    = 0.5,
  ...
  -- Twin Cast: arcane calculus traces the arc well.
  aim = {
    path_base      = 140,
    path_per_level = 12,
  },
