-- ==========================================================================
-- BALL PIT X — DAMAGE MASTER FILE — Pinball Lobber paddle
-- ==========================================================================
-- This file is the single source of truth for every damage number in the
-- game WHILE THE Pinball Lobber PADDLE IS EQUIPPED. Each paddle has its own copy
...
return {
  ...
  loadout = {
    dmg = 1.3, size = 0.5, move = 1.1, ball = 0.7, charge = 1.4, aim = 1.5,
    xp = 1.0, combo = 1.4, hp = 5,
  },

  -- Flipper-table physics. Damage-relevant: flip launches feed the charge
  -- damage ramp (globals.flipper_charge_step/cap).
  signature = {
  ...
  -- Pinball: the flipper rig never aims (SPACE is dead there) — unused.
  aim = {
    path_base      = 0,
    path_per_level = 0,
  },
