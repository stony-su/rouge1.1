-- ==========================================================================
-- BALL PIT X — DAMAGE MASTER FILE — Vampire paddle
-- ==========================================================================
-- This file is the single source of truth for every damage number in the
-- game WHILE THE Vampire PADDLE IS EQUIPPED. Each paddle has its own copy
...
return {
  ...
  loadout = {
    dmg = 1.5, size = 0.9, move = 1.2, ball = 1.3, charge = 1.2, aim = 1.1,
    xp = 1.0, combo = 1.2, hp = 5,
  },

  -- HP drains constantly; kills restore it (1 heart = 20 bar units).
  signature = {
    drain         = 2.0,   -- bar units lost per second
    heal_per_kill = 3,     -- bar units restored per brick kill
  },
  ...
  -- Vampire: predator night-senses — sharp and sharpening.
  aim = {
    path_base      = 130,
    path_per_level = 12,
  },
